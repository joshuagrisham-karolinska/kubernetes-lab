-- copied from: https://github.com/ehrbase/docker/blob/887bac654716f80b58657a473f52d7b4442c5359/dockerfiles/scripts/db-setup.sql
...
-- note: following lines removed since these are created by Crunchy
...
-- note: and then that we can just give the username based on the TLS certificates
--  it is important to escape the double quotes if using dash or other characters in the username!
\set db_user `echo \"ehrbase-db-user\"`
\set db_user_admin `echo \"ehrbase-db-admin\"`
